          ...
          <div className="carousel-inner" style={{height: '600px'}}>
            <div className="carousel-item active">
              ...
              <div className="carousel-caption d-none d-md-block">
                  ...
                  <a href="/free_trial" className="btn btn-outline-light m-2">Free Trial</a>
          ...
          <div className="col">
            <div className="jumbotron jumbotron-fluid">
              <div className="container">
                <div className="row">
                  <div className="col">
                    <h1 className="display-4" style={{color: '#fff'}}>Get Started For Free</h1>
                    <p className="lead" style={{color: '#fff'}}>This is a modified jumbotron that occupies the entire horizontal space of its parent.</p>
                  </div>
                </div>
                <div className="row">
                  <div className="col text-right">
                    <span className="m-2">
                      <button type="button" className="btn btn-outline-light">Free Tools</button>
                    </span>
                    <span className="m-2">
